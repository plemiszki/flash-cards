  ...
  def get_available_questions(quiz_questions:, quiz:)
    ...
    quiz_questions.each do |quiz_question|
      ...
      when 'Card'
        ...
        available_card_ids = quiz.use_archived ? (tagged_card_ids & archived_card_ids) : (tagged_card_ids - archived_card_ids)
        available_questions[quiz_question.id] = available_card_ids.count
      else
        type = {
