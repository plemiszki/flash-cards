      ...
      number_of_questions.times do
        ...
        when 'Card'
          ...
          obj = {
            ...
            cardId: card.id,
            streak: card.streak,
            lastStreakAdd: card.last_streak_add.in_time_zone("America/New_York").try(:to_time).try(:to_i),
        ...
        when 'Hindi - Single Noun'
          ...
          result << {
            ...
            entity: 'noun',
            streak: noun.streak,
            lastStreakAdd: noun.last_streak_add.in_time_zone("America/New_York").try(:to_time).try(:to_i),
        ...
        when 'Hindi - Single Verb'
          ...
          result << {
            ...
            entity: 'verb',
            streak: verb.streak,
            lastStreakAdd: verb.last_streak_add.in_time_zone("America/New_York").try(:to_time).try(:to_i),
        ...
        when 'Hindi - Single Adjective'
          ...
          result << {
            ...
            lastStreakAdd: adjective.last_streak_add.in_time_zone("America/New_York").try(:to_time).try(:to_i),
