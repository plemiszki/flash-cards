  ...
  render() {
    return(
      <div className="modal-select">
        <input className="search-box" onChange={ HandyTools.changeStateToTarget.bind(this, 'searchText') } value={ this.state.searchText } data-field="searchText" />
        <ul className="licensor-modal-list">
          { HandyTools.filterSearchText(this.props.options, this.state.searchText, 'name').map(function(option, index) {
            return(
